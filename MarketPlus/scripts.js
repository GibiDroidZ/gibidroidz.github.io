  ...
  var query = '{"clazz":[' + race + '],"limit":24,"page":1,"stage":[' + form + '],"saleType":[],' + sort + ',"dna":[],"attackArr":[40,88],"defenseArr":[40,88],"healthArr":[40,88],"speedArr":[40,88],"intelligenceArr":[40,88],"ceArr":[' + ce + '],"breedCountArr":[ ' + breedCount + ']}';
  $.ajax({
    type: "POST",
